...
use App\Service\AiRecognizerResolver;
...
$recurringIssuerCatalogService = new RecurringIssuerCatalogService($applicationSettings);
...
$ollamaHelper = new OllamaHelper($applicationSettings, $validators);
$aiRecognizerResolver = new AiRecognizerResolver($applicationSettings, $openAiHelper, $ollamaHelper);
$accountantPackageSummaryService = new AccountantPackageSummaryService();
$pdfInvoiceCandidateParser = new PdfInvoiceCandidateParser($pdfInboxAnalysisService, $pdfPageRenderService, $aiRecognizerResolver->resolve());
